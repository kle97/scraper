...
//                            writer.write("\"" + edition.olKey() + "\": " + editionId + ", ");
                            ...
                            if (filteredWorksMap.size() < MAX_NUMBER_OF_FILTERED_WORKS && grade >= 80
                                    && !filteredWorksMap.containsKey(String.valueOf(editionWorkKey))) {
                                int filteredWorkId = filteredWorksMap.size() + 1;
                                filteredWorksMap.put(String.valueOf(editionWorkKey), filteredWorkId);
                            }
                            if (filteredWorksMap.containsKey(String.valueOf(editionWorkKey))) {
...
//            }
    ...
    public static void processWork() throws IOException {
        ...
        try (BufferedReader reader = Files.newBufferedReader(latestWorkPath, ENCODING);
            ...
            writer1.newLine();
            writer5.write("title,cover,ol_key");
            writer5.newLine();
            while ((line = reader.readLine()) != null) {
    ...
    public static void processAuthor() throws IOException {
        ...
        try (BufferedReader reader = Files.newBufferedReader(latestAuthorPath, ENCODING);
            ...
            writer4.write("name,birth_date,death_date,date,bio,photo,ol_key");
            writer4.newLine();
